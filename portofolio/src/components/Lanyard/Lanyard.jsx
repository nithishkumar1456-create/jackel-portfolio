...
export default function Lanyard({ position = [0, 0, 30], gravity = [0, -40, 0], fov = 20, transparent = true, cardImage = lanyard }) {
  return (
    <div className="lanyard-wrapper">
      <ErrorBoundary fallback={<div className="text-white">Failed to load 3D scene.</div>}>
        <Canvas
